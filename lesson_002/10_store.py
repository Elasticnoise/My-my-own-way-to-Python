...
tables_item_1 = store[tables_code][0]
tables_item_2 = store[tables_code][1]
...
sofas_item_1 = store[sofas_code][0]
sofas_item_2 = store[sofas_code][1]
...
chairs_item_1 = store[chairs_code][0]
chairs_item_2 = store[chairs_code][1]
chairs_item_3 = store[chairs_code][2]
...
chairs_cost = (chairs_quantity_1 * chairs_price_1) + \
